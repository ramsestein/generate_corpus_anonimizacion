...
# ============================================================================
# ANTERIORMENTE, este script filtraba ciertas etiquetas (FAMILIARES_SUJETO_ASISTENCIA,
# PROFESION, OTROS_SUJETO_ASISTENCIA) descartándolas antes de cualquier análisis.
#
# AHORA, ese filtrado ha sido COMPLETAMENTE ELIMINADO.
# 
# RAZÓN: El juez LLM debe evaluar TODAS las entidades sin excepción.
# No aplicamos ningún filtro previo porque:
# 1. Limitaba la capacidad del juez para analizar contexto
# 2. Eliminaba información que podría ser válida según el contexto
# 3. Reducía artificialmente el recall del sistema
#
# A partir de ahora, TODAS las entidades detectadas pasan al pipeline
