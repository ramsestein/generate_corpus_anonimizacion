...
def create_deepseek_prompt(annotations: List[Dict], available_labels: Set[str]) -> str:
    ...
    prompt = f"""Eres un médico especialista redactando un documento clínico en catalán. Debes crear un texto médico completamente natural y fluido que incorpore de manera orgánica ÚNICAMENTE los siguientes datos específicos:
...
- Debe estar escrito integramente en catalán o mezcla de catalán y español
...
async def main_async():
    ...
    parser.add_argument("--output-dir", default="examples/step3_generated_documents",
