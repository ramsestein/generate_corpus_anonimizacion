...
def create_verification_summary(results: List[Dict], output_dir: str):
    ...
    if summary['high_confidence_statistics']['documents_to_delete'] > 0:
        print(f"\n[!] DOCUMENTOS MARCADOS PARA ELIMINACION (Confianza > 0.97):")
...
def main():
    ...
    parser.add_argument("--input-dir", default="examples/step5_anonymized_documents",
                       help="Directorio con documentos anonimizados del paso 3")
    parser.add_argument("--output-dir", default="examples/step6_validation_results",
